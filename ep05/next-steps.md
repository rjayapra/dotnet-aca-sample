...
- Azure Container App to host the 'eshoplite-products' service.
- Azure Container App to host the 'eshoplite-store' service.
- Azure Container App to host the 'eshoplite-weather' service.
